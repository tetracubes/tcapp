...
import * as ClientLogValidations from "./ClientLog-validator";
...
const ClientLog = (props) => {
    ...
    const loadData = async () => {
        ...
        ClientLogService.fetchAll().then((res) => {
            if (res.data) {
    ...
    const dataStruct = {
        fields: {
            clientLogId: { name: "clientLogId", dbname: "clientLogId", componentType: "VIEW", labelDisplayName: "Client Log ID", defvalue: "" },
            // clientLogCode: { name: "clientLogCode", dbname: "clientLogCode", componentType: "VIEW", labelDisplayName: "ClientLog Code", defvalue: "" },
            clientName: { name: "clientName", dbname: "clientName", componentType: "INPUT", labelDisplayName: "Client Name", defvalue: "", autoFocus: true },
            clientLoggroup: {
                name: "clientLoggroup",
                dbname: "clientLoggroup",
    ...
    const handleEdit = (e, rowData) => {
        ...
        let data = { ...rowData };
        data["clientLoggroup"] = utility.getColumnValueasArray(data["clientLoggroup"], "clientGroupName")
    ...
    const getFiledValidated = (key, value) => {
        ...
        let rules = ClientLogValidations.getFieldRules(key, popUpData) || {};
    ...
    const handleSave = () => {
        if (validation()) {
            if (popUpMode == "Add" || popUpMode == "Edit") {
                ...
                if (popUpMode == "Add") delete data["clientLogId"]


                data["clientLoggroup"] = utility.getArrayList({ ...clientGroup }, "clientGroupName", data["clientLoggroup"])
                // console.log(data);
                ...
                console.log(data);
                props.appConfig.SetAppConfig("ready", false);
                ClientLogService.add(popUpData).then((res) => {
                    // console.log(res);
    ...
    const actions = [
        ...
        rowData => ({
            ...
            onClick: (event, rowData) => {
                props.appConfig.SetAppConfig("ready", false);
                ClientLogService.del(rowData["clientLogId"]).then((res) => {
                    // console.log(res);

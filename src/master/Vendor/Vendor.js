...
import * as VendorValidations from "./Vendor-validator";
...
const Vendor = (props) => {
    ...
    const dataStruct = {
        fields: {
            vendorId: { name: "vendorId", dbname: "vendorId", componentType: "VIEW", labelDisplayName: "Vendor ID", defvalue: "" },
            vendorCode: { name: "vendorCode", dbname: "vendorCode", componentType: "VIEW", labelDisplayName: "Vendor Code", defvalue: "" },
    ...
    const handleEdit = (e, rowData) => {
        ...
        let data = { ...rowData };
        data["vendorgroup"] = utility.getColumnValueasArray(data["vendorgroup"], "vendorGroupName")
    ...
    const getFiledValidated = (key, value) => {
        ...
        let rules = VendorValidations.getFieldRules(key, popUpData) || {};
    ...
    const handleSave = () => {
        if (validation()) {
            if (popUpMode == "Add" || popUpMode == "Edit") {
                ...
                if (popUpMode == "Add") delete data["vendorId"]


                data["vendorgroup"] = utility.getArrayList({ ...vendorGroup }, "vendorGroupName", data["vendorgroup"])
                // console.log(data);
                ...
                props.appConfig.SetAppConfig("ready", false);
                VendorService.add(popUpData).then((res) => {
                    // console.log(res);
    ...
    const columnNames = [
        ...
        {
            title: "Vendor Group", field: "vendorgroup", render: rowData => {
                return (JSON.stringify(utility.getColumnValueasArray(rowData["vendorgroup"], "vendorGroupName")))

...
import * as ActivityLogValidations from "./ActivityLog-validator";
...
const ActivityLog = (props) => {
    ...
    const dataStruct = {
        fields: {
            logId: { name: "logId", dbname: "logId", componentType: "VIEW", labelDisplayName: "Log Id", defvalue: "" },
            ...
            clientId: {
                name: "clientId", dbname: "clientId", componentType: "SELECT", labelDisplayName: "Client Code", defvalue: ""
                , getOptions: getOptions, optionName: "clientCode", optionGroupName: "clientName"
            },
            activityGroupId: {
                name: "activityGroupId", dbname: "activityGroupId", componentType: "SELECT",
                getOptions: getOptions, labelDisplayName: "ActivityLog", defvalue: "", optionName: "activityGroupName"
            },
            projectControlId: {
            ...
            product: { name: "product", dbname: "product", componentType: "INPUT", labelDisplayName: "ActivityLog Name", defvalue: "", style: { "width": "300px" } },
            ...
            // activityStatus: { name: "activityStatus", dbname: "activityStatus", componentType: "SELECT", labelDisplayName: "ActivityLog Status", defvalue: "N" },
    ...
    const getFiledValidated = (key, value) => {
        ...
        let rules = ActivityLogValidations.getFieldRules(key, popUpData) || {};
    ...
    const handleSave = () => {
        if (validation()) {
            if (popUpMode == "Add" || popUpMode == "Edit") {
                ...
                if (popUpMode == "Add") delete data["logId"]
                ...
                props.appConfig.SetAppConfig("ready", false);
                ActivityLogService.add(popUpData).then((res) => {
                    // console.log(res);
    ...
    const actions = [
        ...
        rowData => ({
            ...
            onClick: (event, rowData) => {
                props.appConfig.SetAppConfig("ready", false);
                ActivityLogService.del(rowData["logId"]).then((res) => {
                    // console.log(res);
